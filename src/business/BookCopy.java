...
final public class BookCopy implements Serializable {
	...
	BookCopy(Book book, int copyNum, boolean isAvailable) { // is avaiable says the book avaiable or not 
		this.book = book;
	...
	public boolean equals(Object ob) {
		...
		//System.out.println("in equals method "+ (copy.book.getIsbn().equals(book.getIsbn()) && copy.copyNum == copyNum));
