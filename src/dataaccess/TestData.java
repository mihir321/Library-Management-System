...
public class TestData {
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			add(new Book("23-11451", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1)))); //default one copy created and again we adding 
	...
	List<LibraryMember> members = new ArrayList<LibraryMember>() {
		//adding two members 	
		{
				add(new LibraryMember("1001", "Roger", "fedderrer", "641-9544631", addresses.get(0)));
				add(new LibraryMember("1002", "Rafel", "Nadal", "641-9544431", addresses.get(1)));
			}
	};
	...
	public static void main(String[] args) {
		...
		td.bookData();
		td.libraryMemberData(); //for adding library members
		td.userData();
	...
	///create books
	public void bookData() { //create more copy 
	...
	public void checkoutRecordData() 
	{
		...
		DataAccessFacade.loadCheckOutRecordMap(allRecords); //passing to data base 
		//multiple entries
	...
	public void libraryMemberData()  //call in main 
	{
